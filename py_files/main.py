...
# -> CheckHealth Methods
# -> CheckCollision Methods
#       -> Remove Objects form Pitch Methods
#       -> Animation Methods
#       -> Other Methods
# -> SpawnAlien Methods
# -> Popup Methods
...
#
#       -> REMOVE OBJECTS FROM PITCH METHODS
#
    ...
    # Adds a destroy image to the canvas removes it by a delayed call to remAlienDes
    def remAlien(self, remList):
        for item in remList:
            ...
            self.after(100, self.remAlienDes)
    ...
    def remBomber(self, remList):
        for item in remList:
            ...
            self.after(100, self.remDesBomber)
            self.bomber = ""
            self.delete(item.id)
            self.score += 50
            self.accHits += 1
