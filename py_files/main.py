...
class Board(Canvas):
    ...
    def checkCollision(self):
        ...
        for shot in self.shotList:
            ...
            if self.coords(shot[0])[1] <= 30 or self.coords(shot[0])[1] >= HEIGHT:
    ...
    def shoot(self, e):
        if self.shootCooldown == 0:
            ...
            self.shotList.append((self.create_rectangle(shotPos - 2, HEIGHT - 50, shotPos + 2, HEIGHT - 60, width=0, fill="blue", tag="SpaceShipShot"), Shot(shotPos, 4, 10, 0, -20)))
